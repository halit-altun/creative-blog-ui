  ...
  const skills = [
    {
      ...
      description: "HTML5, CSS3, React, Material-UI ile modern ve responsive web arayüzleri geliştirme"
    },
    {
    ...
    },
    {
      ...
      description: "Redux Toolkit, REST API, ES6+, Git, Modern web teknolojileri"
    },
    {
    ...
    },
    {
      ...
      title: "UI/UX Tasarım",
      description: "Kullanıcı deneyimi odaklı, modern ve estetik arayüz tasarımları"
    },
    {
      icon: <Code sx={{ fontSize: 40, color: '#4C00FF' }} />,
      title: "Clean Code",
